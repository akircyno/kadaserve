...
insert into public.menu_items (
  ...
  (
    ...
    'non-coffee',
    95,
    '/images/menu/non-coffee/Choco Milk Drink.png',
    true,
    false,
    true,
    false,
  ...
  (
    ...
    'non-coffee',
    110,
    '/images/menu/non-coffee/Strawberry Latte.png',
    true,
    false,
    true,
    false,
  ...
  (
    ...
    'latte-series',
    120,
    '/images/menu/coffee/Matcha Latte.png',
    true,
    false,
    true,
    false,
  ...
  (
    ...
    'latte-series',
    120,
    '/images/menu/coffee/French Vanilla Latte.png',
    true,
    false,
    true,
    false,
  ...
  (
    ...
    'latte-series',
    120,
    '/images/menu/coffee/Brown Sugar Latte.png',
    true,
    false,
    true,
    false,
  ...
  (
    ...
    'latte-series',
    125,
    '/images/menu/coffee/Spanish Latte.png',
    true,
    false,
    true,
    false,
  ...
  (
    ...
    'premium-blends',
    140,
    '/images/menu/premium-blends/strawberry matcha.png',
    true,
    false,
    true,
    false,
  ...
  (
    ...
    'premium-blends',
    130,
    '/images/menu/premium-blends/Caramel Macchiato.png',
    true,
    false,
    true,
    false,
  ...
  (
    ...
    'premium-blends',
    130,
    '/images/menu/premium-blends/mocha.png',
    true,
    false,
    true,
    false,
